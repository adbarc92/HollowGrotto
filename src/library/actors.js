import {
  G_CHARACTER_OLD_MAN,
  G_CHARACTER_STATUE_RUNNER,
  G_CHARACTER_STATUE_THINKER,
  G_CHARACTER_STATUE_SPEAKER,
  G_SIGN_POT_ROOM,
  G_CHARACTER_PARTY_POT,
  G_CHARACTER_POT,
  G_CHARACTER_POT_REAL,
  G_CHARACTER_POT_FAKE,
  G_CHARACTER_JIN,
  G_CHARACTER_SPIKES,
  G_SIGN_SPIKES_ARE_DANGEROUS,
  G_SIGN_POINTLESS_FALL,
  G_SIGN_POINTY_FALL,
  G_SIGN_POINTY_FALL_SUCCESS,
  G_CHARACTER_ITEM_BOMB,
  G_CHARACTER_FAKE_WALL,
  G_CHARACTER_ITEM_STATUE_LEGS,
  G_SIGN_SHRINE_OF_LEGS,
  G_CHARACTER_ORANGE,
  G_CHARACTER_ITEM_MARBLE,
  G_SIGN_MONSTER_ROOM,
  G_CHARACTER_ITEM_STATUE_MIND,
  G_ROAMER_ENCOUNTER_1,
  G_ROAMER_ENCOUNTER_2,
  G_ROAMER_ENCOUNTER_3,
  G_ROAMER_ENCOUNTER_4,
  G_ROAMER_ENCOUNTER_5,
  G_ROAMER_ENCOUNTER_6,
  G_ROAMER_ENCOUNTER_7,
